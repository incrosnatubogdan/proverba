<template>
    <v-dialog v-model="getAuthPopup" persistent max-width="600px" min-width="360px">
        <v-tabs v-model="tab" show-arrows background-color="deep-purple accent-4" icons-and-text dark grow>
            ...
            <v-tab-item>
                <v-card class="px-4">
                    <v-card-text>
                        <v-form ref="socialForm" v-model="valid" lazy-validation>
                            <v-row>
                                <v-col>
                                    <v-btn icon href="/login/facebook" target="_blank" color="success">
